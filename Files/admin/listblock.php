...
<h3 class="page-title"> View Banned Users <small></small></h3>
<hr>
...
<?php
$ddaa = mysql_query("SELECT id, firstname, lastname, mobile, email, mallu, block FROM users WHERE block='1' ORDER BY id");
