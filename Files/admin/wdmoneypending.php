...
<?php
$ddaa = mysql_query("SELECT `id`, `method`, `usr`, `amount`, `details`, `msg` FROM wd  WHERE status='0' ORDER BY id");
    echo mysql_error();
    while ($data = mysql_fetch_array($ddaa))
    {

$userdet = mysql_fetch_array(mysql_query("SELECT firstname, lastname, email FROM users WHERE id='".$data[2]."'"));
 ...
 <tr>
   ...
   <td>$data[4]</td>
   <td>$data[5]</td>
   <td><a href=\"?success=$data[0]\" class=\"btn purple btn-xs\"> <i class=\"fa fa-edit\"></i> Mark Success</a></td>
