...
$res = mysql_query("UPDATE general_setting SET head='".$name."', htext='".$btext."' WHERE id='1'");
echo mysql_error();
if($res){
...
$old = mysql_fetch_array(mysql_query("SELECT head, htext FROM general_setting WHERE id='1'"));
?>										
