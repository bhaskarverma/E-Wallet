...
?>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> General Setting -  [c o d e l i s t . c c ]
                        <small></small>
                    </h3>
                    <!-- END PAGE TITLE-->
...
if ($error == 0){
$res = mysql_query("UPDATE general_setting SET sitetitle='".$title."' WHERE id='1'");
echo mysql_error();
if($res){
...
$old = mysql_fetch_array(mysql_query("SELECT sitetitle FROM general_setting WHERE id='1'"));
