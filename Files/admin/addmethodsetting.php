...
?>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> PayPal And PM Setting
                        <small></small>
                    </h3>
                    <!-- END PAGE TITLE-->
...
$res = mysql_query("UPDATE payment_method SET paypal='".$pp."', pmuid='".$pm."', pmsec='".$pms."' WHERE id='1'");
echo mysql_error();
if($res){
...
$old = mysql_fetch_array(mysql_query("SELECT paypal, pmuid, pmsec FROM payment_method WHERE id='1'"));
