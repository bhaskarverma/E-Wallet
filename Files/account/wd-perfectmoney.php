...
<h4 class="title text-white uppercase">Withdraw Money - PerfectMoney</h4>
</div>
...
$details="PerfectMoney Account: $goesto";
...
mysql_query("INSERT INTO trx SET who='".$uid."', byy='000wd', amount='".$amount."', sig='-', typ='Withdraw By PerfectMoney', charge='0', tm='".$tm."', trxid='".$trx."', msg='".$msg."'");

mysql_query("INSERT INTO wd SET method='PerfectMoney', usr='".$uid."', amount='".$amount."', tm='".$tm."', details='".$details."', msg='".$msg."'");
...
$txt = "You Just Submit a Withdraw Request. Amount: $amount USD. Method: PerfectMoney";
...
<br><input type="text" class="form-control input-lg"  name="goesto" placeholder="PerfectMoney USD Account" required>
