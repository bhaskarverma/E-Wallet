...
$userdetails = mysql_fetch_array(mysql_query("SELECT id, firstname, mallu, block, sid, mv FROM users WHERE email='".$user."'"));
$uid = $userdetails[0];
$mallu = $userdetails[2];
$ufnm = $userdetails[1];
    ...
    <div class="container">
      <div class="navbar navbar-default yamm">
        <div class="navbar-header">
          ...
          <a href="<?php echo $baseurl; ?>/dashboard" class="navbar-brand"><img src="<?php echo $mainpage; ?>/logo.png" style="width: 180px;" alt=""/></a> </div>
...
<li> <a href="<?php echo $baseurl; ?>/updateprofile"><i class="fa fa-edit"></i> Update Profile</a> </li>
<li> <a href="<?php echo $baseurl; ?>/changepassword"><i class="fa fa-cog"></i> Change Password</a> </li>
<li> <a href="<?php echo $baseurl; ?>/signout"><i class="fa fa-sign-out"></i> Sign Out</a> </li>
